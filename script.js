...
function fanc() {
  if (select.value === "visa") {
    ...
    blockst.innerHTML += `
    <div class="blo">
    <img class="img1" src="./img/img/1.png" alt="img">
     <div class = "h33">
    <h3 class = "h1 hh1"> name : ${input1.value}</h3>
    <h3 class = "h2 hh2"></br> ${input2.value}</h3>
    
    <h3 class = "hh4"> Cvv :  ${input4.value}</h3>
    <h3 class = "hh3"> Date : ${input3.value}</h3>
    </div>
    </div>
    `;
